-- Construction Packages Migration (COMPLETE & FIXED)
...
-- 3. INSERT ALL FEATURES & VALUES

-- DESIGN & ENGINEERING
INSERT INTO features (id, title, type, value_mode, display_order) VALUES ('f100', 'DESIGN & ENGINEERING', 'heading', 'boolean', 10);
INSERT INTO features (id, title, type, value_mode, display_order) VALUES ('f1', 'Soil Test', 'feature', 'boolean', 11);
INSERT INTO features (id, title, type, value_mode, display_order) VALUES ('f2', 'Borewell Test', 'feature', 'boolean', 12);
INSERT INTO features (id, title, type, value_mode, display_order) VALUES ('f3', '2D Floor Plan', 'feature', 'boolean', 13);
INSERT INTO features (id, title, type, value_mode, display_order) VALUES ('f4', '3D Elevation', 'feature', 'text', 14);
INSERT INTO features (id, title, type, value_mode, display_order) VALUES ('f5', 'Structural Design', 'feature', 'boolean', 15);
INSERT INTO features (id, title, type, value_mode, display_order) VALUES ('f6', 'Electrical Drawing', 'feature', 'boolean', 16);
...
-- STRUCTURE
INSERT INTO features (id, title, type, value_mode, display_order) VALUES ('f200', 'STRUCTURE', 'heading', 'boolean', 20);
INSERT INTO features (id, title, type, value_mode, display_order) VALUES ('f7', 'Cement', 'feature', 'text', 21);
INSERT INTO features (id, title, type, value_mode, display_order) VALUES ('f8', 'Steel', 'feature', 'text', 22);
INSERT INTO features (id, title, type, value_mode, display_order) VALUES ('f9', 'RCC Grade', 'feature', 'text', 23);
INSERT INTO features (id, title, type, value_mode, display_order) VALUES ('f10', 'Foundation', 'feature', 'text', 24);
INSERT INTO features (id, title, type, value_mode, display_order) VALUES ('f11', 'Foundation Waterproofing', 'feature', 'text', 25);
...
-- FLOOR STRUCTURE
INSERT INTO features (id, title, type, value_mode, display_order) VALUES ('f300', 'FLOOR STRUCTURE', 'heading', 'boolean', 30);
INSERT INTO features (id, title, type, value_mode, display_order) VALUES ('f12', 'Floor Height', 'feature', 'text', 31), ('f13', 'Parking Height', 'feature', 'text', 32), ('f14', 'Lintel', 'feature', 'text', 33), ('f15', 'Loft', 'feature', 'text', 34), ('f16', 'Ceiling Height', 'feature', 'text', 35), ('f17', 'Sand', 'feature', 'text', 36), ('f18', 'Plastering', 'feature', 'text', 37), ('f19', 'Brick Work', 'feature', 'text', 38);
...
('46868bf6-6f62-4f0d-8b9c-ad0e1f203101', 'f14', 'text', 'Through Lintel'), ('46868bf6-6f62-4f0d-8b9c-ad0e1f203102', 'f14', 'text', 'Same'), ('46868bf6-6f62-4f0d-8b9c-ad0e1f203103', 'f14', 'text', 'Same'),
...
-- ELECTRICAL
INSERT INTO features (id, title, type, value_mode, display_order) VALUES ('f400', 'ELECTRICAL', 'heading', 'boolean', 40);
INSERT INTO features (id, title, type, value_mode, display_order) VALUES ('f20', 'Wiring', 'feature', 'text', 41), ('f21', 'Switch MCB', 'feature', 'text', 42), ('f22', 'Switch Model', 'feature', 'text', 43), ('f23', 'Main Board', 'feature', 'text', 44);
...
-- PLUMBING
INSERT INTO features (id, title, type, value_mode, display_order) VALUES ('f500', 'PLUMBING', 'heading', 'boolean', 50);
INSERT INTO features (id, title, type, value_mode, display_order) VALUES ('f24', 'CPVC Concealed', 'feature', 'text', 51), ('f25', 'Potable Cold Water', 'feature', 'text', 52), ('f26', 'Grey Water Pipes', 'feature', 'text', 53);
...
-- KITCHEN
INSERT INTO features (id, title, type, value_mode, display_order) VALUES ('f600', 'KITCHEN', 'heading', 'boolean', 60);
INSERT INTO features (id, title, type, value_mode, display_order) VALUES ('f27', 'Kitchen Wall Tiles', 'feature', 'text', 61), ('f28', 'Kitchen Flooring', 'feature', 'text', 62), ('f29', 'Countertop', 'feature', 'text', 63), ('f30', 'Sink', 'feature', 'text', 64);
...
-- BATHROOM
INSERT INTO features (id, title, type, value_mode, display_order) VALUES ('f700', 'BATHROOM', 'heading', 'boolean', 70);
INSERT INTO features (id, title, type, value_mode, display_order) VALUES ('f31', 'Bathroom Wall Tiles', 'feature', 'text', 71), ('f32', 'Fittings', 'feature', 'text', 72);
...
-- FLOORING
INSERT INTO features (id, title, type, value_mode, display_order) VALUES ('f800', 'FLOORING', 'heading', 'boolean', 80);
INSERT INTO features (id, title, type, value_mode, display_order) VALUES ('f33', 'Parking Flooring', 'feature', 'text', 81), ('f34', 'Living / Bedroom Flooring', 'feature', 'text', 82), ('f35', 'Staircase Flooring', 'feature', 'text', 83), ('f36', 'Balcony Flooring', 'feature', 'text', 84);
...
-- UTILITY
INSERT INTO features (id, title, type, value_mode, display_order) VALUES ('f900', 'UTILITY', 'heading', 'boolean', 90);
INSERT INTO features (id, title, type, value_mode, display_order) VALUES ('f37', 'Utility Flooring', 'feature', 'text', 91), ('f38', 'Utility Counter Top', 'feature', 'boolean', 92), ('f39', 'CP Fittings', 'feature', 'text', 93), ('f40', 'Utility Sink', 'feature', 'boolean', 94);
...
-- DOORS & JOINERY
INSERT INTO features (id, title, type, value_mode, display_order) VALUES ('f1000', 'DOORS & JOINERY', 'heading', 'boolean', 100);
INSERT INTO features (id, title, type, value_mode, display_order) VALUES ('f41', 'Main Door Frame', 'feature', 'text', 101), ('f42', 'Door Accessories', 'feature', 'text', 102), ('f43', 'Bedroom Door', 'feature', 'text', 103), ('f44', 'Bathroom Door', 'feature', 'text', 104), ('f45', 'Windows', 'feature', 'text', 105);
...
-- RAILINGS
INSERT INTO features (id, title, type, value_mode, display_order) VALUES ('f1100', 'RAILINGS', 'heading', 'boolean', 110);
INSERT INTO features (id, title, type, value_mode, display_order) VALUES ('f46', 'Staircase Railing', 'feature', 'text', 111), ('f47', 'Balcony Railing', 'feature', 'text', 112);
...
-- PAINT
INSERT INTO features (id, title, type, value_mode, display_order) VALUES ('f1200', 'PAINT', 'heading', 'boolean', 120);
INSERT INTO features (id, title, type, value_mode, display_order) VALUES ('f48', 'Internal Walls', 'feature', 'text', 121), ('f49', 'External Paint', 'feature', 'text', 122);
...
-- EXTRA ELECTRICAL
INSERT INTO features (id, title, type, value_mode, display_order) VALUES ('f1300', 'EXTRA ELECTRICAL', 'heading', 'boolean', 130);
INSERT INTO features (id, title, type, value_mode, display_order) VALUES ('f50', 'AC Points', 'feature', 'text', 131), ('f51', 'EV Charging', 'feature', 'boolean', 132), ('f52', 'Inverter Wiring', 'feature', 'boolean', 133), ('f53', 'Pressure Pump Provision', 'feature', 'boolean', 134), ('f54', 'Solar Heater Provision', 'feature', 'boolean', 135), ('f55', 'CCTV Wiring', 'feature', 'boolean', 136);
